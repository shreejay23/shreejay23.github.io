...
//         hidden: { opacity: 0 },
//       }}
//       className="max-w-xl bg-gray-100 rounded-lg border border-gray-200 shadow-lg dark:bg-gray-800 dark:border-gray-700 my-8"
//     >
//       <div className="p-5">
//         <h5 className="mb-2 text-center rounded-lg bg-blue-500 text-2xl font-medium tracking-tight text-white ">
//           {props.project.title}
//         </h5>
...
//           </ul>
//         </div>
//         <a className="" href={props.project.githubLink} target="_blank">
//           <button
//             type="button"
//             data-te-ripple-init
    ...
    >
      ...
      <div className="ml-5 mb-2 mt-auto">
        ...
        {props.project.onYouTube && (
          <a className="" href={props.project.youtubeLink} target="_blank">
            <button
              type="button"
              data-te-ripple-init
              data-te-ripple-color="light"
